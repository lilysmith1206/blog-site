...
namespace LylinkDb_UnitTests
{
    public static class UnitTestData
    {
        ...
        public static Post IndexPost1 = new Post { Slug = "index-post-1", Title = "About Me", ParentId = 1, DateCreated = DateTime.Now.AddDays(-10), DateModified = DateTime.Now.AddDays(-5), Name = "Index Post 1", Keywords = "index, about me", Description = "About the blogger.", Body = "This post introduces the blogger on the index level category." };
