...
function generatePost(post: string, timeUpdated: string, dateUpdated: string) {
    ...
    return `<!DOCTYPE html>
                <html lang="en">
                    <head>
                        ...
                        <link rel="stylesheet" href="site_color">
                        <link rel="stylesheet" href="mobile_style">

                        <link rel="stylesheet" href="table_style" />
